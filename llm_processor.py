...
#         # Simple, generic extraction prompt
#         prompt = f"""
# Extract key financial information from this term sheet document and return it as JSON.

# Document: {filename}

# Fields to extract:
# - isin: ISIN identifier (e.g., NO0010894330, INE008A08U84)
# - issuer: Company or bank issuing the bonds
# - coupon_rate: Interest rate as a number (e.g., 9.25 for 9.25%)
# - currency: Currency code (e.g., USD, INR, EUR)
# - issue_amount: Total amount being raised
# - face_value: Face value per bond/unit
# - issue_date: Issue date in YYYY-MM-DD format if available
# - maturity_date: Maturity date in YYYY-MM-DD format if available
# - tenor: Tenor description (e.g., "5 years", "Perpetual")
# - payment_frequency: Interest payment frequency (e.g., "Annual", "Semi-annual")
...
#                 messages=[
#                     {"role": "system", "content": "You are a financial document analyst. Extract information accurately and return valid JSON only."},
